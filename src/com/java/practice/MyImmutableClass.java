...
follow these rules. This does not necessarily mean the creators of these classes were sloppy — they may have good reason for
...
final class MyImmutable {
	...
	public String toString() {
		return "MyImmutable{" + "id=" + id + ", branch='" + branch + '\'' + ", desc=" + desc + '}';
	}
}
